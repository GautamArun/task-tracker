                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-semibold uppercase text-gray-500">Update</th>
                            </tr>
                        </thead>
                            ...
                            @forelse($tasks as $task)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <form action="{{ route('employee.tasks.update-status', $task) }}"
                                            method="POST"
                                            ...
                                            <button type="submit"
                                                    class="rounded-lg bg-gray-900 px-3 py-2 text-sm text-white hover:bg-gray-700">
                                                Save
                                            </button>
                                        </form>
                                    </td>
